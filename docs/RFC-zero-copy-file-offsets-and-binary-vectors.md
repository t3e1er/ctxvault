...
related:
  - "[[docs/index]]"
  - "[[docs/CODEROADMAP]]"
  - "[[docs/adr-anchor-embedding]]"
  - "[[docs/how-cast-chunking-works]]"
  - "[[docs/why-hybrid-retrieval]]"
---
...
**Date**: September 2026  
**Related Documents**: [[docs/CODEROADMAP]], [[docs/adr-anchor-embedding]], [[docs/how-cast-chunking-works]]
