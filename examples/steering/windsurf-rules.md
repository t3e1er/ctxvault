...
- When creating notes, discover schemas using `list_templates` and verify compliance with `validate_note`.
- Use `promote_concept` to record lasting engineering decisions.
```
