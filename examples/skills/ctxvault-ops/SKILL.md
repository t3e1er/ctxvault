...
description: >-
  ...
  and inspect graph topological metrics and community clusters using ctxvault MCP tools.
  Use this skill when synchronizing index state after filesystem changes or analyzing vault connectivity statistics.
---

# Ctxvault Operations, Index Lifecycle & Graph Topology

This skill guides agents through operational maintenance of `ctxvault` knowledge bases and codebases, including delta synchronization, index rebuilds, embedding refreshes, and topological community analysis using the 17-tool suite.
