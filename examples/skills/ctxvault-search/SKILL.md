...
This skill teaches agents how to effectively query knowledge bases using `ctxvault`'s hybrid 3-Way Reciprocal Rank Fusion (RRF), BM25 lexical search, dense ONNX vector search, and Petgraph typed graph traversal.
