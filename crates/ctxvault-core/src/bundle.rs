...
use ctxvault_common::error::{Error, Result};
...
pub struct BundleManifest {
    ...
    /// Ctxvault crate version that produced the bundle.
    pub ctxvault_version: String,
...
pub fn export_bundle(
    ...
    let manifest = BundleManifest {
        ...
        ctxvault_version: env!("CARGO_PKG_VERSION").to_string(),
        source_commit,
    };
