...
use ctxvault_common::config::TemplateEdgeSchema;
...
impl Template {
    ...
    pub const CANDIDATE_TEMPLATE_DIRS: &'static [&'static str] =
        &["docs/.templates", ".templates", ".ctxvault/templates", "docs/templates"];
...
mod tests {
    use super::*;
    use ctxvault_common::config::{EdgeClass, EdgeDirection};
    use std::fs;
