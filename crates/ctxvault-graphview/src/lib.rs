//! `ctxvault-graphview`: Standalone 3D knowledge graph visualizer and agent telemetry substrate.
//!
...
pub async fn run_graphview_server(
    ...
    eprintln!(
        "\n\
        +========================================================================+\n\
        |  ctxvault GraphView 3D Dashboard is Running                            |\n\
        |                                                                        |\n\
        |  * Web UI:        http://{:<45}|\n\
    ...
    info!(addr = %local_addr, "ctxvault-graphview server listening");
