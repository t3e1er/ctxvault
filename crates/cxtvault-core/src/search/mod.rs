...
use cxtvault_common::types::{ScoreBreakdown, SearchResult};
use cxtvault_common::Result;
...
pub fn search_semantic_dual(
    ...
    query: &str,
    limit: usize,
    depth: cxtvault_common::types::SearchDepth,
) -> Result<Vec<SearchResult>> {
    use cxtvault_common::types::SearchDepth;
...
pub fn search_hybrid(
    ...
    edge_class_filter: Option<cxtvault_common::config::EdgeClass>,
) -> Result<Vec<SearchResult>> {
...
pub fn search_explain(
    ...
    edge_type_filter: Option<&[String]>,
    edge_class_filter: Option<cxtvault_common::config::EdgeClass>,
) -> Result<Vec<cxtvault_common::types::SearchExplanation>> {
    use cxtvault_common::types::{GraphExplanation, SearchExplanation, SignalExplanation};
...
pub fn search_multihop(
    ...
    use cxtvault_common::config::EdgeClass;
...
mod tests {
    use super::*;
    use cxtvault_common::types::{Chunk, EdgeProvenance};
    ...
    fn setup_graph() -> KnowledgeGraph {
        ...
        graph.add_edge(
            ...
            cxtvault_common::config::EdgeClass::Structural,
        );
        graph.add_edge(
            "notes/rust.md",
            "notes/web.md",
    ...
    fn test_search_graph_with_edge_filter() {
        ...
        graph.add_edge(
            ...
            cxtvault_common::config::EdgeClass::Semantic,
        );
        graph.add_edge(
            "B",
            "D",
