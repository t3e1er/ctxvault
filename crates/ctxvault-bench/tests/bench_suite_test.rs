...
use ctxvault_bench::dataset::loader::DatasetLoader;
use ctxvault_bench::dataset::schema::{BenchmarkDataset, BenchmarkQuery, RelevanceJudgment};
use ctxvault_bench::metrics::ir::IrEvaluator;
use ctxvault_bench::metrics::latency::LatencyTracker;
use ctxvault_bench::profile::disk::DiskProfiler;
use ctxvault_bench::profile::index_profiler::{IndexProfiler, IndexProfilerOptions};
use ctxvault_bench::profile::memory::MemoryTracker;
...
fn test_end_to_end_indexing_and_retrieval_bench() {
    ...
    assert!(md.contains("# ctxvault Retrieval & Indexing Benchmark Report"));
